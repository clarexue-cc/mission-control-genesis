...
const endpoints: Endpoint[] = [
  ...
  { path: '/api/tasks/uat', methods: ['GET', 'POST'], description: 'Customer UAT task list and admin creation', tag: 'Tasks', auth: 'viewer/admin' },
  { path: '/api/tasks/uat/:id/submit', methods: ['POST'], description: 'Customer UAT feedback submission', tag: 'Tasks', auth: 'customer-view' },
  { path: '/api/tasks/uat/:id/submissions', methods: ['GET'], description: 'Admin UAT feedback review', tag: 'Tasks', auth: 'admin' },
