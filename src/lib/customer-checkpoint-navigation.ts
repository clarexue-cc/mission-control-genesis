...
export const customerCheckpointNavItems: CustomerCheckpointNavItem[] = [
  ...
  { id: 'p10-golden', label: 'P10 Golden Tests', panel: 'tests', tenantScoped: true },
  { id: 'p11-adversarial', label: 'P11 Adversarial Tests', panel: 'tests', tenantScoped: true },
  ...
  { id: 'p14-hermes-channels', label: 'P14 Hermes + Channels', panel: 'hermes', tenantScoped: true },
